...
const Event = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Card style={styles.menuCard1} elevation={5}>
          <Card.Content
            style={{
              flexDirection: "column",
              justifyContent: "center",
        ...
        <Card style={styles.menuCard2} elevation={5}>
          <Card.Content>
            <Text style={styles.menuCardHeading}>View Your Events</Text>
          </Card.Content>
        </Card>
        <Card style={styles.menuCard3} elevation={5}>
          <Card.Content>
            <Text style={styles.menuCardHeading}>Add Event</Text>
          </Card.Content>
        </Card>
        <Card style={styles.menuCard4} elevation={5}>
          <Card.Content>
